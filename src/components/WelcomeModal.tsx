        ...
        <View style={style.modalContent}>
          ...
          <View style={[style.overlayText, style.instructionContent]}>
            <Text style={style.instructionText}>
              {`Step 1. Create a Board: \nAdd a title and description to represent your goals and aspirations.`}
            </Text>
            <Text style={style.instructionText}>
              {`Step 2. Search Photos: \nFind images that resonate with your goals to add to the board.`}
            </Text>
            <Text style={style.instructionText}>
              {`Step 3. View Your Boards: \nReview your boards under your profile to stay inspired and focused on your goals.`}
            </Text>
          </View>
